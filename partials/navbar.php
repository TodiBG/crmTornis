...
?>
<nav class="navbar navbar-expand-lg navbar-dark shadow-sm sticky-top" style="background-color: #0B3041 !important; z-index: 1030;">
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarCRM">
            <!--
                Ce conteneur flex stabilise la navbar sur desktop comme sur mobile.
                On peut ainsi separer proprement les liens metier et le bloc utilisateur.
            -->
            <div class="d-lg-flex align-items-lg-center justify-content-lg-end w-100">
                <!--
                ...
                <!--
                    ...
                    Il regroupe les informations liees a la session : connexion, profil, deconnexion.
                -->
                <ul class="navbar-nav ms-lg-4 ps-lg-3 border-top border-light border-opacity-25 pt-2 pt-lg-0 mt-2 mt-lg-0">
                    <?php if ($authenticatedUser !== null): ?>
                        <?php
